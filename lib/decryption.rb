class Decryption
  ...
  def change_a(letter)
    @shift.set_a_shift(@shift.key, @shift.date, true)[find(letter)]
  end

  def change_b(letter)
    @shift.set_b_shift(@shift.key, @shift.date, true)[find(letter)]
  end

  def change_c(letter)
    @shift.set_c_shift(@shift.key, @shift.date, true)[find(letter)]
  end

  def change_d(letter)
    @shift.set_d_shift(@shift.key, @shift.date, true)[find(letter)]
  end
